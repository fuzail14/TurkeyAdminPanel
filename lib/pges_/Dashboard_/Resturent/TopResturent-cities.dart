...
import 'Cities-Resturent.dart';

class Resturent_cities extends StatefulWidget {
  String? coverimages;
  String? content;
  String? maincatagory;
  Resturent_cities(
  ...
  @override
  State<Resturent_cities> createState() => _Resturent_citiesState();
}

class _Resturent_citiesState extends State<Resturent_cities> {
  var newlatlang;
              ...
              child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      log_sigup(
                        text: "Set Resturent Cites",
                        onpressed: () async {
                          FirebaseFirestore firestore = FirebaseFirestore.instance;
                          try {
                            if (topresturentimg != null && cityname.text.isNotEmpty) {
                              await firestore.collection("City-list").add({
                                "cityimage": topresturentimg,
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => cities_wiseresturents(
                                      cityimage: topresturentimg.toString(),
                                      cityname: cityname.text,
                                    )));
                          } catch (e) {
                            ScaffoldMessenger.of(context).showSnackBar(
