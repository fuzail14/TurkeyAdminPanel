...
class Topresturent extends StatefulWidget {
  // String? coverimages;
  // String? content;
  // String? maincatagory;
  // Topresturent(
  ...
  @override
  State<Topresturent> createState() => _TopresturentState();
}

class _TopresturentState extends State<Topresturent> {
  var newlatlang;
  String formattedDate =
      DateFormat('MMMM, dd, yyy , kk:mm a').format(DateTime.now());
  TextEditingController topresturentname = TextEditingController();
                    ...
                    onpressed: () async {
                      ...
                      try {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Resturent_cities(content: '', coverimages: '', maincatagory: '',)));
                      } catch (e) {
                        ScaffoldMessenger.of(context).showSnackBar(
